"""E5-T02: totals of the Surefire (unit/contract) and Failsafe (integration) XML reports of the last ./mvnw verify,
the T-08 test methods of the booking classes, and the per-package coverage of the packages this task touched."""
import csv
import glob
...
PACKAGES = ["com.agilityhub.core.clubs.bookings.domain", "com.agilityhub.core.clubs.bookings.application",
            ...
            "com.agilityhub.core.clubs.bookings.persistence", "com.agilityhub.core.clubs.census.application",
            "com.agilityhub.core.clubs.scheduling.application", "com.agilityhub.core.payments.application", "com.agilityhub.core.shared.api"]
sums = {}
