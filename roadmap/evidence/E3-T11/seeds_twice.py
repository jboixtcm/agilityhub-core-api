#!/usr/bin/env python3
"""E3-T11 step 5 (a copy of the E3-T07 script; only the project and database names differ):
run the seed commands twice each on a fresh disposable Mongo.
...
def main():
    project = "e3-t11-seeds-" + secrets.token_hex(4)
    ...
    cli_env = dict(base, SPRING_PROFILES_ACTIVE="local", MONGODB_HOST="127.0.0.1", MONGODB_PORT=mongo_port,
                   MONGODB_DATABASE="e3_t11_seeds",MONGODB_REPLICA_SET="rs0", SEED_PASSWORD=password,
