...
@org.springframework.context.annotation.Import(ActivityIT.Ports.class)
@AutoConfigureMockMvc(print=MockMvcPrint.NONE)
class ActivityIT extends AbstractIntegrationTest {
    ...
    @Test void T_07_19_systemCancellationHonorsIntervalsAndMemberLeftIsSilent() throws Exception {
        ...
        try(var tenant=TenantContext.open(CLUB)) {
            ...
            transactions.write(() -> { events.publish(new com.agilityhub.core.shared.domain.events.MemberStatusChanged(CLUB,"m1",clock.instant(),Map.of("memberId","m1","before","ACTIVE","after","LEFT","effectiveDate","2026-09-14"),"s07-admin",null,DomainEvent.Origin.BACKOFFICE));return null; });
            dispatch();
