...
public final class SettingsContracts {
    ...
    public record ClubSettings(
            ...
            @Schema(requiredMode = NOT_REQUIRED, nullable = true, description = "Normalized: upper case, without spaces or separators (S02 §3). ES: a 7-digit DNI is stored padded to 8 digits.") String taxId,
