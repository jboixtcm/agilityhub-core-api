...
public final class SettingsContracts {
    ...
    public record ClubSettings(
            ...
            @Schema(requiredMode = NOT_REQUIRED, description = "The town shown with the club's name (S02 §3); /branding falls back to address.city without it.") String displayCity,
    ...
    public record ClubUpdate(
            ...
            @Schema(requiredMode = NOT_REQUIRED) String legalName,
            @Schema(requiredMode = NOT_REQUIRED, description = "Checked by the club's country profile (ES: CIF, NIF or NIE with its check character).") String taxId,
            @Schema(requiredMode = NOT_REQUIRED, description = "The registered office (S02 §3); /branding.legalAddress.") ClubAddress address,
            @Schema(requiredMode = NOT_REQUIRED, description = "The town shown with the club's name (S02 §3); null clears it, and /branding shows address.city.") String displayCity,
            @Schema(requiredMode = NOT_REQUIRED) String contactEmail,
            @Schema(requiredMode = NOT_REQUIRED) String contactPhone,
            @Schema(requiredMode = NOT_REQUIRED) String websiteUrl,
