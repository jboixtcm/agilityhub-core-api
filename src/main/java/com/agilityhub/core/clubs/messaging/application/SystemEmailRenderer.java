...
public final class SystemEmailRenderer {
    ...
    public EmailMessage render(String code, String to, Locale locale, Map<String, ?> variables,
        ...
        if (!Set.of("N-01", "N-02", "N-03", "N-08a", "N-08b", "N-32a", "N-32b", "N-32c", "N-32d", "N-25", "N-26", "N-27", "N-39", "N-42", "N-36", "N-40").contains(code)) { throw new ApiException(ErrorCode.TEMPLATE_NOT_SENDABLE); }
        String link = null;
        String expiry = null;
